...
export const ThemeLanguageProvider = ({ children }) => {
  ...
  const translations = {
    pt: {
      ...
      profile_link_copied:
        "O link do perfil foi copiado para área de transferência",
      ...
      no_topics_available: "Nenhum tópico disponível no momento.",
      ...
      topic_reports_desc:
        "Discussão sobre relatórios e métricas de desempenho.",
      topic_fullstack_desc:
      ...
      topic_python_desc:
        "Comunidade Python: Data Science, Web, Automação e mais.",
      topic_others_desc:
        "Tópicos diversos que não se encaixam em outras categorias.",
      ...
      achievement_title_label: "Título *",
      achievement_title_placeholder: "Ex: AWS Certified Developer",
      achievement_type_label: "Tipo *",
      achievement_description_label: "Descrição",
      achievement_description_placeholder: "Descreva sua conquista, habilidades aplicadas ou resultado alcançado...",
      achievement_date_label: "Data *",
      technologies_tools_label: "Tecnologias ou Ferramentas",
      technologies_placeholder: "Ex: React, Node.js, MongoDB (separadas por vírgula)",
      add: "Adicionar",
      ...
      ranking_info_text:
        "No final de cada mês, os participantes que alcançarem o topo do ranking receberão um prêmio exclusivo da Codemia! Participe, dê o seu melhor e conquiste recompensas especiais pelo seu desempenho.",
      no_users_in_ranking: "Nenhum usuário no ranking ainda.",
      name_unavailable: "Nome indisponível",
      user_type_undefined: "Tipo não definido",
      error_loading_ranking: "Não foi possível carregar o ranking.",
    },
    en: {
      ...
      no_topics_available: "No topics available at the moment.",
      ...
      topic_fullstack_desc:
        "Discussion about development focused on FullStack (Frontend and Backend).",
      topic_c_desc: "C Programming: questions, projects and best practices.",
      topic_python_desc:
        "Python Community: Data Science, Web, Automation and more.",
      topic_others_desc:
        "Various topics that do not fit into other categories.",
      ...
      achievement_title_label: "Title *",
      achievement_title_placeholder: "Ex: AWS Certified Developer",
      achievement_type_label: "Type *",
      achievement_description_label: "Description",
      achievement_description_placeholder: "Describe your achievement, applied skills or result achieved...",
      achievement_date_label: "Date *",
      technologies_tools_label: "Technologies or Tools",
      technologies_placeholder: "Ex: React, Node.js, MongoDB (separated by comma)",
      add: "Add",
      ...
      ranking_title: "Ranking",
      ranking_info_text:
        "At the end of each month, participants who reach the top of the ranking will receive an exclusive prize from Codemia! Join in, do your best, and earn special rewards for your dedication and performance.",
      no_users_in_ranking: "No users in the ranking yet.",
      name_unavailable: "Name unavailable",
      user_type_undefined: "User type not defined",
      error_loading_ranking: "Unable to load ranking.",
    },
  };
